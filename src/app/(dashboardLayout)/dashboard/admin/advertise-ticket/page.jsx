...
import TicketAdvertisementClient from "./TicketAdvertisemetClient";

export default async function AdvertiseTickets() {
  ...
  return (
    <div className="p-6 relative overflow-hidden min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <TicketAdvertisementClient initialTickets={tickets} />
      </div>
    </div>
  );
}
