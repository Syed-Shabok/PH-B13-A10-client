...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#091624] relative overflow-hidden">
      ...
      <main className="container mx-auto px-6 pt-24 pb-16 space-y-32">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
              <div>
                <h2 className="text-3xl md:text-4xl font-black uppercase tracking-widest text-white">
                  Featured <span className="text-[#AAFFC7]">Routes</span>
                </h2>
        ...
        <section className="relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 gap-4">
            ...
            <Link href="/all-tickets">
              <Button
                variant="bordered"
                className="border-[#00ADB5]/30 text-[#00ADB5] hover:bg-[#00ADB5]/10 font-bold uppercase tracking-widest rounded-xl"
              >
                View All Tickets
              </Button>
            </Link>
          ...
          {latestTickets.length > 0 ? (
            ...
            <div className="flex justify-center items-center h-40 border border-[#1a3d61] bg-[#102226]/40 rounded-3xl backdrop-blur-xl shadow-lg">
        ...
        <section className="relative z-10 bg-gradient-to-br from-[#124170]/40 to-[#102226]/80 border border-[#1a3d61] rounded-[3rem] p-12 text-center backdrop-blur-xl shadow-2xl overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#00ADB5]/20 rounded-full blur-[80px] pointer-events-none" />
          <h2 className="text-3xl font-black uppercase tracking-widest text-white mb-4 relative z-10">
            Ready for your next journey?
          </h2>
          <p className="text-zinc-300 mb-8 max-w-xl mx-auto relative z-10">
            Join thousands of passengers who trust Tikify for their daily
            transit and luxury travel needs.
          </p>
          <Link href="/all-tickets">
            <Button className="bg-white text-[#091624] hover:bg-zinc-200 font-black uppercase tracking-widest rounded-2xl h-14 px-10 shadow-lg relative z-10">
              Start Booking Now
            </Button>
          </Link>
        </section>
